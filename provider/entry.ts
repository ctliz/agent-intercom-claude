...
class ClaudeBossProtectedProviderStartUnavailableError extends Error {
  ...
  constructor() {
    ...
    this.name = "ClaudeBossProtectedProviderStartUnavailableError";
  }
}

/** A later protected service may replace this dormant entry after release gates. */
export function startClaudeBossProtectedProvider(_request: unknown): never {
  throw new ClaudeBossProtectedProviderStartUnavailableError();
}
